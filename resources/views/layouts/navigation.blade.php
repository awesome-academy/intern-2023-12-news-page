<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex nav-content">
                    ...
                    @if (Auth::user()->role->slug === 'moderator')
                        <x-nav-link :href="route('manager.post.index')" :active="request()->routeIs('manager.post.index')">
                            {{ __('Handle') . ' ' . __('Posts') }}
                        </x-nav-link>
                    ...
                    @if (Auth::user()->role->slug === 'admin' || Auth::user()->role->slug === 'moderator')
                        <x-nav-link :href="route('manager.users.index')" :active="request()->routeIs('manager.users.index')">
                            {{ __('Users') }}
                        </x-nav-link>
                    @endif
                </div>
                        ...
                        <x-slot name="trigger">
                            <button
                                ...
                                <div class="flex items-center">
                                    <div>
                                        <img title="Avatar của {{ Auth::user()->name }}" class="img-manager mr-2"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role->slug === 'moderator')
                <x-responsive-nav-link :href="route('manager.post.index')" :active="request()->routeIs('manager.post.index')">
                    {{ __('Handle') . ' ' . __('Posts') }}
                </x-responsive-nav-link>
