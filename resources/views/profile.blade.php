                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="">
                        <h3 style="margin-bottom: 20px"
                            class="h3 font-semibold text-xl text-gray-800 leading-tight"> {{ __('Info User')}} </h3>
                        <div style="margin-bottom: 20px;flex-wrap: wrap;"
                            ...
                            <div class="drop-area w-full rounded-md border-2 border-dotted border-gray-200
                                ...
                                <div class="preview-container hidden items-center justify-center flex-col">
                                    ...
                                    <p class="close-button cursor-pointer transition-all mb-4 rounded-md px-3 py-1
