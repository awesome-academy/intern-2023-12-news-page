            ...
            <div class="row js-parent">
                <div class="col-md-6">
                    <div class="info-post-item d-flex">
                        <img
                            src="{{ asset(!empty($userInfo->avatar) ? $userInfo->avatar : 'images/avatar_default.png') }}"
                        ...
                        <h5>
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <div class="d-flex item-footer mt-2">
                                    <span class="item-footer" style="margin-right: 20px">{{ formatDate($userInfo->created_at) }}</span>
                ...
                <div class="action-detail col-md-6 d-flex align-items-center justify-content-end">
                    <a class="btn btn-danger js-report" data-toggle="modal"
                       data-type="{{ config('constants.user.userType') }}"
                       data-target="#reportModal" data-id="{{ $userId }}">
