    ...
    <div class="container">
        <header class="main-navbar d-flex align-items-center">
            <div class="d-flex main-navbar__left align-items-center">
                <a href="{{ route('landingPage') }}" class="main-navbar__logo d-block mr-lg-3">
            ...
            <div class="d-flex main-navbar__right align-items-center w-50">
                <div class="main-nav__group position-relative flex-fill mr-1">
                    <form method="GET" action="{{ route('search.nextPage') }}" class="js-search-nextPage">
                        <label class="w-100">
                            <input data-route = "{{ route('ajax.search') }}" id = "searchMain" name = "search"
                                placeholder="{{ __('Search for posts/user/hashtag') }}">
                        </label>
                        <button class="btn btn-dark position-absolute right-0" type="submit">
                            <i class="fa-solid fa-magnifying-glass"></i>
                        </button>
                    </form>
                    <div class="result-search-box">
                        <div class="h-100" style="padding: 15px;">
