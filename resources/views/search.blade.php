    ...
    <div class="container-fluid">
        <div class="container">
            <div class="main-content__box">
                <h4>{{ __('New Posts') . ' ' . __('From') }} <span class="text-primary">Khoa học và Công nghệ</span>
                </h4>
            ...
            <div class="main-content__box">
                <h4>{{ __('Authenticated Posts') . ' ' . __('From') }} <span
                        class="text-primary">Khoa học và Công nghệ</span></h4>
                <div class="main-content__list-item">
                    <a href="{{ route('detail') }}" class="main-content__item">
                        <div class="w-100 h-100 main-container__item">
                            <div class="info-post-item d-flex">
            ...
            <div class="main-content__box">
                <h4>{{ __('High Interactions Posts') . ' ' . __('From') }} <span class="text-primary">Khoa học và Công nghệ</span>
                </h4>
                <div class="main-content__list-item">
                    <a href="{{ route('detail') }}" class="main-content__item">
                        <div class="w-100 h-100 main-container__item">
